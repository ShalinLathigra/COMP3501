...
uniform float particle_size = 0.4;
...
void main(void){
    ...
    float p_size = particle_size * vertex_color[0].g; //
    ...
    for (int i = 0; i < 4; i++){
        ...
        frag_color = vec4(vec3(timestep[0]), vertex_color[0].a); // Specify only blending value
